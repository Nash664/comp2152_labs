...
if not input_invalid:
  ...
  @        ..@#% @     @&*#@(         % 
   &   (  @    (   / /   *    @  .   /  
    ...
    # Use Loot
    belt, health_points=functions_lab05.use_loot(belt, good_loot_options, bad_loot_options, health_points)
...
while m_health_points > 0 and health_points > 0:
    ...
    if attack_roll in [1, 3, 5]: 
        ...
        m_health_points = functions_lab05.hero_attack(combat_strength, m_health_points)
...
while True:
    ...
    if len(name_parts) == 2 and all(part.isalpha() for part in name_parts):
        ...
        print("Invalid name. Please enter a name with two words and only letters")
